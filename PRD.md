...
- 기업들이 수동으로 공고를 확인하여 연간 수백 시간 소모
- RFP 문서(HWP/PDF) 분석에 전문 인력 투입 필요
- 수주 가능성 판단의 주관성과 경험 의존도 높음
- 중요한 입찰 기회를 놓치는 경우 빈번 발생

**해결하려는 문제**:
- 입찰정보 모니터링 자동화 및 실시간 알림
- AI 기반 객관적 수주 가능성 예측
- 기업 역량 기반 맞춤형 프로젝트 추천
- RFP 문서의 자동 분석 및 핵심 요구사항 추출
- 경쟁사 분석 및 입찰 전략 수립 지원
...
- **맞춤형 알림 서비스**
  ...
  - 알림 채널 선택 (이메일, SMS, 카카오톡, Slack, 웹푸시)
  - 알림 빈도 및 시간대 커스터마이징
